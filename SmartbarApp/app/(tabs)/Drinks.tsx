      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.menuSection}>
          ...
          <MenuItem 
            ...
            image={require('../../assets/images/miitz.jpg')} 
          />
          
          <MenuItem 
            name="Amstel" 
            price="1500frws" 
             image={require('../../assets/images/amstel.jpg')} 
          />
          ...
          <MenuItem 
            name="Heiniken" 
            price="2500frws" 
           image={require('../../assets/images/heiniken.jpg')} 
          />
        </View>
      </ScrollView>
...
const MenuItem = ({ name, price, image }: any) => (
