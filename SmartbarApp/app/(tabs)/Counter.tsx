    ...
    <SafeAreaView style={styles.container} edges={["top", "bottom"]}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => { setLoading(true); fetchDrinksData(); }}
          activeOpacity={0.7}
        >
                  ...
                  item.items.map((drink, idx) => (
                    <View key={idx} style={styles.itemRowWrapper}>
                      <View style={styles.quantityContainer}>
                        <Text style={styles.quantityText}>{drink?.quantity || 1}x</Text>
                      </View>
                      <Text style={styles.itemNameText}>{drink?.name || 'Unknown Item'}</Text>
                    </View>
                  ))
                ) : (
